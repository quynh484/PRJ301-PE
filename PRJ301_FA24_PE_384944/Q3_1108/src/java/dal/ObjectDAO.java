...
//    }
    ...
    public List<Option> findOption() {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                list.add(new Option(rs.getInt(1), rs.getString(2)));
            }
        } catch (Exception e) {
            System.err.println("------------------------- E:  " + e);
        }
    ...
    public List<Object> find(String keyword) {
        List<Object> list = new ArrayList<>();
        String sql = "select * from [Executions] e join [Types] t on e.TypeID = t.TypeID";
    ...
    public List<Object> findByOption(String opt) {
        List<Object> list = new ArrayList<>();
        String sql = "select * from [Executions] e join [Types] t on e.TypeID = t.TypeID";
